...
def set_rules(world: "GlyphsWorld"):
    ...
    # Region 2
    set_rule_from_string(world, "(R2S1) Silver Shard Puzzle 4 - Save Button",       lambda state: can_dash(state, player)                     and can_press_green_buttons(state, player))
    set_rule_from_string(world, "(R2) Silver Shard Puzzle 5 - Respawn",             lambda state: can_dash(state, player))
    ...
    set_rule_from_string(world, "(R2) Gilded Serpent Reward",                       lambda state: defeated_gilded_serpent(state, player))
    ...
    set_rule_from_string(world, "(R2) Serpent Boss Room Pickup",                    lambda state: can_dash(state, player)                     and (options.LogicalWallJumps.value                 or (state.can_reach_region("Region 2 - Serpent Upper", player)      and can_press_green_buttons(state, player)              and defeated_gilded_serpent(state, player))))
    ...
    set_rule_from_string(world, "(R3) Red Stone Trial",                             lambda state: can_dash(state, player)                     and has_grapple(state, player)                      and can_fight(state, player, world))
    ...
    set_rule_from_string(world, "(R3) Silver Shard Puzzle 11 - No Dash",            lambda state: can_dash(state, player)                     and has_grapple(state, player)                      and can_press_green_buttons(state, player))
    ...
    # Region 4
    set_rule_from_string(world, "(R4) Spearman Reward",                             lambda state: can_dash_attack(state, player)              and has_grapple(state, player)                      and can_fight(state, player, world))
    ...
    # Collapse
    set_rule_from_string(world, "(Esc) Escape the Escape Sequence",                 lambda state: can_dash(state, player)                     and has_grapple(state, player))
    ...
    set_rule_from_string(world, "(Dark) Null Reward",                               lambda state: can_dash_attack(state, player)              and has_grapple(state, player)                      and has_sword(state, player))
    ...
    set_rule_from_string(world, "(Void 2) Pink Bow Pickup",                         lambda state: can_dash(state, player)                     or has_grapple(state, player))
