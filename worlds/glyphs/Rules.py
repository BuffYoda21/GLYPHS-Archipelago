...
def set_rules(world: "GlyphsWorld"):
    ...
    connect_regions(world, player, "Region 3",                  "Region 4 - Lower",         lambda: can_dash(state, player)                   and can_press_green_buttons(state, player)  and defeated_gilded_serpent(state, player)  and has_grapple(state, player)  and can_parry(state, player))
    ...
    set_rule_from_string("Serpent Lock 3",          lambda: can_dash(state, player))
