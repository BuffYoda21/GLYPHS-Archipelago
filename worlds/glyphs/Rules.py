...
def connect_entrances(world: "GlyphsWorld"):
  ...
  # connect_areas(world, "Region 2J",       "Region 2I",            lambda state: can_chain_wall_jumps(state, player, world))   # logically will never be needed without save button sanity
    ...
    connect_areas(world, "Region 2L",       "Region 2M",            lambda state: can_dash(state, player)                   and can_press_buttons(state, player, world, ["R2L Right", "R2L Decent Upper Left", "R2L Decent Upper Right", "R2L Decent Upper Middle", "R2L Decent Middle", "R2L Decent Lower"]))
    ...
    connect_areas(world, "Region 3G",       "Region 3H",            lambda state: can_dash(state, player)                   and has_grapple(state, player)              and can_press_button(state, player, world, "R3G Right") and (get_button_color(world, "R3G Right") == ButtonColor.GREEN) or can_press_button(state, player, world, "R3G Left"))
