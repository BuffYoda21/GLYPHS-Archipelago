...
glyphs_chapters = {
    ...
    "Region 1 - Central":       ItemData(38,    ItemClassification.progression),
    "Region 1 - Left":          ItemData(39,    ItemClassification.progression),
    "Region 1 - Upper Left":    ItemData(40,    ItemClassification.progression),
    "Region 1 - Upper Right":   ItemData(41,    ItemClassification.progression),
    "Region 2 - Left":          ItemData(42,    ItemClassification.progression),
    "Region 2 - Central":       ItemData(43,    ItemClassification.progression),
    "Region 2 - Sector 1":      ItemData(44,    ItemClassification.progression),
    "Region 2 - Sector 2":      ItemData(45,    ItemClassification.progression),
    "Region 2 - Sector 4":      ItemData(46,    ItemClassification.progression),
    "Region 2 - Sector 4 End":  ItemData(47,    ItemClassification.progression),
    "Region 2 - Lower":         ItemData(48,    ItemClassification.progression),
    "Region 2 - Serpent":       ItemData(49,    ItemClassification.progression),
    "Region 2 - Shadow Chase":  ItemData(50,    ItemClassification.progression),
    "Region 3":                 ItemData(51,    ItemClassification.progression),
    "Region 4 - Entrance":      ItemData(52,    ItemClassification.progression),
    "Region 4 - Upper":         ItemData(53,    ItemClassification.progression),
    "Region 4 - Central":       ItemData(54,    ItemClassification.progression),
    "Region 4 - Lower":         ItemData(55,    ItemClassification.progression),
    "Collapse":                 ItemData(56,    ItemClassification.progression),
    "Smile Shop":               ItemData(57,    ItemClassification.progression),
    "Dark Region":              ItemData(58,    ItemClassification.progression),
    "The Between":              ItemData(59,    ItemClassification.progression),
    "Act 1":                    ItemData(60,    ItemClassification.progression),
    "Act 2":                    ItemData(61,    ItemClassification.progression),
    "Act 3":                    ItemData(62,    ItemClassification.progression),
    "Epilogue":                 ItemData(63,    ItemClassification.progression),
}
...
junk_items = {
    # Junk Items
    "HP Refill":                ItemData(64,    ItemClassification.filler,                                          0),
    "Pink Bow":                 ItemData(65,    ItemClassification.filler,                                          0),
    "Propeller Hat":            ItemData(66,    ItemClassification.filler,                                          0),
    "Traffic Cone":             ItemData(67,    ItemClassification.filler,                                          0),
    "John Hat":                 ItemData(68,    ItemClassification.filler,                                          0),
    "Top Hat":                  ItemData(69,    ItemClassification.filler,                                          0),
    "Fez":                      ItemData(70,    ItemClassification.filler,                                          0),
    "Party Hat":                ItemData(71,    ItemClassification.filler,                                          0),
    "Bomb Hat":                 ItemData(72,    ItemClassification.filler,                                          0),
    "Crown":                    ItemData(73,    ItemClassification.filler,                                          0),

    # Traps
    "sMiLE Trap":               ItemData(74,    ItemClassification.trap,                                            0),
    "John Trap":                ItemData(75,    ItemClassification.trap,                                            0),
    "Spear Trap":               ItemData(76,    ItemClassification.trap,                                            0),
    "Instakill Trap":           ItemData(77,    ItemClassification.trap,                                            0),
    "Screen Flip Trap":         ItemData(78,    ItemClassification.trap,                                            0),
    "Enemy Trap":               ItemData(79,    ItemClassification.trap,                                            0),
}
