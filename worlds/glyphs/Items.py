...
glyphs_chapters = {
    ...
    "Region 2 - Serpent Upper": ItemData(49,    ItemClassification.progression),
    "Region 2 - Serpent Lower": ItemData(50,    ItemClassification.progression),
    "Region 2 - Shadow Chase":  ItemData(51,    ItemClassification.progression),
    "Region 3":                 ItemData(52,    ItemClassification.progression),
    "Region 4 - Entrance":      ItemData(53,    ItemClassification.progression),
    "Region 4 - Upper":         ItemData(54,    ItemClassification.progression),
    "Region 4 - Central":       ItemData(55,    ItemClassification.progression),
    "Region 4 - Lower":         ItemData(56,    ItemClassification.progression),
    "Collapse":                 ItemData(57,    ItemClassification.progression),
    "Smile Shop":               ItemData(58,    ItemClassification.progression),
    "Dark Region":              ItemData(59,    ItemClassification.progression),
    "The Between":              ItemData(60,    ItemClassification.progression),
    "Act 1":                    ItemData(61,    ItemClassification.progression),
    "Act 2":                    ItemData(62,    ItemClassification.progression),
    "Act 3":                    ItemData(63,    ItemClassification.progression),
    "Epilogue":                 ItemData(64,    ItemClassification.progression),
}
...
junk_items = {
    # Junk Items
    "HP Refill":                ItemData(65,    ItemClassification.filler,                                          0),
    "Pink Bow":                 ItemData(66,    ItemClassification.filler,                                          0),
    "Propeller Hat":            ItemData(67,    ItemClassification.filler,                                          0),
    "Traffic Cone":             ItemData(68,    ItemClassification.filler,                                          0),
    "John Hat":                 ItemData(69,    ItemClassification.filler,                                          0),
    "Top Hat":                  ItemData(70,    ItemClassification.filler,                                          0),
    "Fez":                      ItemData(71,    ItemClassification.filler,                                          0),
    "Party Hat":                ItemData(72,    ItemClassification.filler,                                          0),
    "Bomb Hat":                 ItemData(73,    ItemClassification.filler,                                          0),
    "Crown":                    ItemData(74,    ItemClassification.filler,                                          0),
