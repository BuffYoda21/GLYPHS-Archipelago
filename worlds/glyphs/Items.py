...
# ---Item Name------------------------ap_code-----------------------classifications-------------------------------count--
    ...
    # Upgrades
    "Sword Rune":               ItemData(11,    ItemClassification.useful,                                          1),
    "Shroud":                   ItemData(12,    ItemClassification.useful,                                          1),
    "Fast Magic":               ItemData(13,    ItemClassification.useful,                                          1),
    "Swift Parry":              ItemData(14,    ItemClassification.useful,                                          1),
    "Progressive Chicken Hat":  ItemData(15,    ItemClassification.useful,                                          2),

    # Goal items
    "Ending":                   ItemData(16,    ItemClassification.progression_skip_balancing,                      7),
    "Goal":                     ItemData(17,    ItemClassification.progression_skip_balancing,                      1),
}
...
glyphs_chapters = {
    "Menu":                     ItemData(18,    ItemClassification.progression),    # using this as starting chapter to allow randomized starting spawns
    "Region 1":                 ItemData(19,    ItemClassification.progression),
    "Region 2":                 ItemData(20,    ItemClassification.progression),
    "Region 3":                 ItemData(21,    ItemClassification.progression),
    "Region 4":                 ItemData(22,    ItemClassification.progression),
    "Smile Shop":               ItemData(23,    ItemClassification.progression),
    "Act 1":                    ItemData(24,    ItemClassification.progression),
    "Act 2":                    ItemData(25,    ItemClassification.progression),
    "Act 3":                    ItemData(26,    ItemClassification.progression),
    "Epilogue":                 ItemData(27,    ItemClassification.progression),
}
