...
# ---Item Name------------------------ap_code-----------------------classifications-------------------------------count--
    ...
    "Wizard True Defeat":       ItemData(21,    ItemClassification.progression_skip_balancing,                      1),
    ...
    "All Main Endings":         ItemData(35,    ItemClassification.progression_skip_balancing,                      1),
    "All Star Endings":         ItemData(36,    ItemClassification.progression_skip_balancing,                      1),
    "All Endings":              ItemData(37,    ItemClassification.progression_skip_balancing,                      1),
    "Goal":                     ItemData(38,    ItemClassification.progression_skip_balancing,                      1),
}
...
glyphs_chapters = {
    "Menu":                     ItemData(39,    ItemClassification.progression),    # using this as starting chapter to allow randomized starting spawns
    "Region 1":                 ItemData(40,    ItemClassification.progression),
    "Region 2":                 ItemData(41,    ItemClassification.progression),
    "Region 3":                 ItemData(42,    ItemClassification.progression),
    "Region 4":                 ItemData(43,    ItemClassification.progression),
    "Smile Shop":               ItemData(44,    ItemClassification.progression),
    "Dark Region":              ItemData(45,    ItemClassification.progression),
...
junk_items = {
    ...
    "Dumb Hat":                 ItemData(52,    ItemClassification.filler,                                          0),
    ...
    "Death Trap":               ItemData(63,    ItemClassification.trap,                                            0),
}
