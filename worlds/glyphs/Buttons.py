...
glyphs_buttons = {
    ...
    "R1B Save":                 ButtonData(11,  "Region 1B",     ButtonColor.RED,    validColors=[ButtonColor.RED, ButtonColor.BLUE, ButtonColor.GREEN, ButtonColor.YELLOW]),
    ...
    "R1E Save":                 ButtonData(14,  "Region 1E",     ButtonColor.RED,    validColors=[ButtonColor.RED, ButtonColor.BLUE, ButtonColor.GREEN, ButtonColor.YELLOW]),
    ...
    "R2A Left Save":            ButtonData(18,  "Region 2A",     ButtonColor.RED,    validColors=[ButtonColor.RED, ButtonColor.BLUE, ButtonColor.GREEN, ButtonColor.YELLOW]),
    "R2A Right Save":           ButtonData(19,  "Region 2A",     ButtonColor.RED,    validColors=[ButtonColor.RED, ButtonColor.BLUE, ButtonColor.GREEN, ButtonColor.YELLOW]),
    ...
    "R2B Left Save":            ButtonData(23,  "Region 2B",     ButtonColor.RED,    validColors=[ButtonColor.RED, ButtonColor.BLUE, ButtonColor.GREEN, ButtonColor.YELLOW]),
    "R2B Right Save":           ButtonData(24,  "Region 2B",     ButtonColor.RED,    validColors=[ButtonColor.RED, ButtonColor.BLUE, ButtonColor.GREEN, ButtonColor.YELLOW]),
    "R2D Save":                 ButtonData(25,  "Region 2D",     ButtonColor.RED,    validColors=[ButtonColor.RED, ButtonColor.BLUE, ButtonColor.GREEN, ButtonColor.YELLOW]),
    "R2E Lower Save":           ButtonData(26,  "Region 2E",     ButtonColor.RED,    validColors=[ButtonColor.RED, ButtonColor.BLUE, ButtonColor.GREEN, ButtonColor.YELLOW]),
    "R2E Upper Save":           ButtonData(27,  "Region 2E",     ButtonColor.RED,    validColors=[ButtonColor.RED, ButtonColor.BLUE, ButtonColor.GREEN, ButtonColor.YELLOW]),
    ...
    "R2F Save":                 ButtonData(32,  "Region 2F",     ButtonColor.RED,    validColors=[ButtonColor.RED, ButtonColor.BLUE, ButtonColor.GREEN, ButtonColor.YELLOW]),
    ...
    "R2H Save":                 ButtonData(40,  "Region 2H",     ButtonColor.RED,    validColors=[ButtonColor.RED, ButtonColor.BLUE, ButtonColor.GREEN, ButtonColor.YELLOW]),
    ...
    "R2I Save":                 ButtonData(48,  "Region 2I",     ButtonColor.RED,    validColors=[ButtonColor.RED, ButtonColor.BLUE, ButtonColor.GREEN, ButtonColor.YELLOW]),
    ...
    "R2J Save":                 ButtonData(50,  "Region 2J",     ButtonColor.RED,    validColors=[ButtonColor.RED, ButtonColor.BLUE, ButtonColor.GREEN, ButtonColor.YELLOW]),
    ...
    "R2K Chase 2":              ButtonData(52,  "Region 2K",     ButtonColor.GREEN,  validColors=[ButtonColor.RED, ButtonColor.BLUE, ButtonColor.GREEN, ButtonColor.YELLOW, ButtonColor.PINK]),
    "R2K Chase 3":              ButtonData(53,  "Region 2K",     ButtonColor.BLUE,   validColors=[ButtonColor.RED, ButtonColor.BLUE, ButtonColor.GREEN, ButtonColor.YELLOW, ButtonColor.PINK]),
    "R2K Chase 4":              ButtonData(54,  "Region 2K",     ButtonColor.GREEN,  validColors=[ButtonColor.GREEN, ButtonColor.PINK]),
    ...
    "R2L Save":                 ButtonData(78,  "Region 2L",     ButtonColor.RED,    validColors=[ButtonColor.RED, ButtonColor.BLUE, ButtonColor.GREEN, ButtonColor.YELLOW]),
    ...
    "R2M Save":                 ButtonData(84,  "Region 2M",     ButtonColor.RED,    validColors=[ButtonColor.RED, ButtonColor.BLUE, ButtonColor.GREEN, ButtonColor.YELLOW]),
    ...
    "R2N Save":                 ButtonData(87,  "Region 2N",     ButtonColor.RED,    validColors=[ButtonColor.RED, ButtonColor.BLUE, ButtonColor.GREEN, ButtonColor.YELLOW]),
    ...
    "R2P Save":                 ButtonData(92,  "Region 2P",     ButtonColor.RED,    validColors=[ButtonColor.RED, ButtonColor.BLUE, ButtonColor.GREEN, ButtonColor.YELLOW]),
    "R2Q Save":                 ButtonData(93,  "Region 2Q",     ButtonColor.RED,    validColors=[ButtonColor.RED, ButtonColor.BLUE, ButtonColor.GREEN, ButtonColor.YELLOW]),
    ...
    "R3A Save":                 ButtonData(99,  "Region 3A",     ButtonColor.RED,    validColors=[ButtonColor.RED, ButtonColor.BLUE, ButtonColor.GREEN, ButtonColor.YELLOW]),
    "R3B Save":                 ButtonData(100, "Region 3B",     ButtonColor.RED,    validColors=[ButtonColor.RED, ButtonColor.BLUE, ButtonColor.GREEN, ButtonColor.YELLOW]),
    ...
    "R3C Save":                 ButtonData(105, "Region 3C",     ButtonColor.RED,    validColors=[ButtonColor.RED, ButtonColor.BLUE, ButtonColor.GREEN, ButtonColor.YELLOW]),
    ...
    "R3D Save":                 ButtonData(109, "Region 3D",     ButtonColor.RED,    validColors=[ButtonColor.RED, ButtonColor.BLUE, ButtonColor.GREEN, ButtonColor.YELLOW]),
    ...
    "R3E Save":                 ButtonData(120, "Region 3E",     ButtonColor.RED,    validColors=[ButtonColor.RED, ButtonColor.BLUE, ButtonColor.GREEN, ButtonColor.YELLOW]),
    ...
    "R3F Save":                 ButtonData(122, "Region 3F",     ButtonColor.RED,    validColors=[ButtonColor.RED, ButtonColor.BLUE, ButtonColor.GREEN, ButtonColor.YELLOW]),
    ...
    "R3G Save":                 ButtonData(125, "Region 3G",     ButtonColor.RED,    validColors=[ButtonColor.RED, ButtonColor.BLUE, ButtonColor.GREEN, ButtonColor.YELLOW]),
    ...
    "R3H Save":                 ButtonData(130, "Region 3H",     ButtonColor.RED,    validColors=[ButtonColor.RED, ButtonColor.BLUE, ButtonColor.GREEN, ButtonColor.YELLOW]),
    ...
    "R3I Save":                 ButtonData(135, "Region 3I",     ButtonColor.RED,    validColors=[ButtonColor.RED, ButtonColor.BLUE, ButtonColor.GREEN, ButtonColor.YELLOW]),
    ...
    "R4B Save":                 ButtonData(139, "Region 4B",     ButtonColor.RED,    validColors=[ButtonColor.RED, ButtonColor.BLUE, ButtonColor.GREEN, ButtonColor.YELLOW]),
    ...
    "R4D Save":                 ButtonData(170, "Region 4D",     ButtonColor.RED,    validColors=[ButtonColor.RED, ButtonColor.BLUE, ButtonColor.GREEN, ButtonColor.YELLOW]),
    "R4E Save":                 ButtonData(171, "Region 4E",     ButtonColor.RED,    validColors=[ButtonColor.RED, ButtonColor.BLUE, ButtonColor.GREEN, ButtonColor.YELLOW]),
    "R4F Lower":                ButtonData(172, "Region 4F",     ButtonColor.GREEN,  validColors=[ButtonColor.GREEN, ButtonColor.PINK]),
    "R4F Save":                 ButtonData(173, "Region 4F",     ButtonColor.RED,    validColors=[ButtonColor.RED, ButtonColor.BLUE, ButtonColor.GREEN, ButtonColor.YELLOW]),
    ...
    "R4H Save":                 ButtonData(181, "Region 4H",     ButtonColor.RED,    validColors=[ButtonColor.RED, ButtonColor.BLUE, ButtonColor.GREEN, ButtonColor.YELLOW]),
    ...
    "R4I Save":                 ButtonData(185, "Region 4I",     ButtonColor.RED,    validColors=[ButtonColor.RED, ButtonColor.BLUE, ButtonColor.GREEN, ButtonColor.YELLOW]),
    "R4J Save":                 ButtonData(186, "Region 4J",     ButtonColor.RED,    validColors=[ButtonColor.RED, ButtonColor.BLUE, ButtonColor.GREEN, ButtonColor.YELLOW]),
    ...
    "Dark Save":                ButtonData(193, "Dark Region B", ButtonColor.RED,    validColors=[ButtonColor.RED, ButtonColor.BLUE, ButtonColor.GREEN, ButtonColor.YELLOW]),
    ...
    "Epilouge 1":               ButtonData(202, "Epilogue",      ButtonColor.RED,    validColors=[ButtonColor.RED, ButtonColor.BLUE, ButtonColor.GREEN, ButtonColor.YELLOW]),
    "Between Save":             ButtonData(203, "The Between",   ButtonColor.RED,   validColors=[ButtonColor.RED, ButtonColor.BLUE, ButtonColor.GREEN, ButtonColor.YELLOW]),
