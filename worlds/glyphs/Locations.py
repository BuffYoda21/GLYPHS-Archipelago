...
def is_valid_location(world: "GlyphsWorld", name) -> bool:
    if name is "(R1) Starting Item" and world.options.SaveButtonSanity.value:
        return False # this location is removed if save button sanity is enabled
    if name in glyphs_locations or (name in save_buttons and world.options.SaveButtonSanity.value and not name.endswith(world.starting_save_button)):
        return True
    return False
...
save_buttons = {
    # Region 1
    "(R1) Region 1 Save 1 - Entrance":                  LocData(101, "Region 1A"),
    "(R1) Region 1 Save 2 - Construct":                 LocData(102, "Region 1E"),
    "(R1) Region 1 Save 3 - Map":                       LocData(103, "Region 1B"),
    "(R1) Region 1 Save 4 - Region 2 Gate":             LocData(104, "Region 2A"),

    # Region 2
    "(R2) Region 2 Save 1 - Region 2 Gate":             LocData(105, "Region 2A"),
    "(R2) Region 2 Save 2 - Central Area":              LocData(106, "Region 2B"),
    "(R2) Region 2 Save 3 - Serpent Gate":              LocData(107, "Region 2B"),
    "(R2S1) Silver Shard 4 Save Button":                LocData(108, "Region 2D"),
    "(R2S1) Region 2 Save 4 - Near Serpent Lock 1":     LocData(109, "Region 2E"),
    "(R2) Region 2 Save 5 - Below Smile Shop Entrance": LocData(110, "Region 2E"),
    "(R2) Smile Shop Entrance Save Button":             LocData(111, "Region 2F"),
    "(R2S2) Region 2 Save 6 - Near Serpent Lock 2":     LocData(112, "Region 2H"),
    "(R2S2) Region 2 Save 7 - Near Stalker Door":       LocData(113, "Region 2I"),
    "(R2S2) Stalker Door Save Button":                  LocData(114, "Region 2J"),
    "(R2) Region 2 Save 8 - Near Collapsed Tunnel":     LocData(115, "Region 2L"),
    "(R2S4) Region 2 Save 9 - Near Serpent Lock 3":     LocData(116, "Region 2M"),
    "(R2) Region 2 Save 10 - Above Serpent":            LocData(117, "Region 2N"),
    "(R2) Region 2 Save 11 - After Serpent":            LocData(118, "Region 2P"),
    "(R2) Region 2 Save 12 - Before Long Fall":         LocData(119, "Region 2Q"),

    # Region 3
    "(R3) Region 3 Crossroads Save":                    LocData(120, "Region 3A"),
    "(R3) Region 3 Green Save 1":                       LocData(121, "Region 3B"),
    "(R3) Region 3 Green Save 2":                       LocData(122, "Region 3C"),
    "(R3) Region 3 Green Save 3":                       LocData(123, "Region 3D"),
    "(R3) Region 3 Red Save 1":                         LocData(124, "Region 3E"),
    "(R3) Region 3 Red Save 2":                         LocData(125, "Region 3F"),
    "(R3) Region 3 Blue Save 1":                        LocData(126, "Region 3G"),
    "(R3) Region 3 Blue Save 2":                        LocData(127, "Region 3H"),
    "(R3) Region 3 Blue Save 3":                        LocData(128, "Region 3I"),

    # Region 4
    "(R4) Region 4 Save 1 - Before Spearman":           LocData(129, "Region 4B"),
    "(R4) Region 4 Save 2 - Central Area":              LocData(130, "Region 4D"),
    "(R4) Flower Room Save Button":                     LocData(131, "Region 4E"),
    "(R4) Region 4 Save 3 - Bottom Right":              LocData(132, "Region 4F"),
    "(R4) Region 4 Save 4 - The Gate":                  LocData(133, "Region 4I"),
    "(R4) Primary Glyph Save Button":                   LocData(134, "Region 4J"),

    # Dark Region
    "(Dark) Clarity Altar Save Button":                 LocData(135, "Dark Region B"),

    # The Between
    "(Between) Between Save Button":                    LocData(136, "The Between")
}
