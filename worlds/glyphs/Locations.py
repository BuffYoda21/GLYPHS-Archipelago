...
glyphs_locations = {
    ...
    "Smile Token Puzzle 3":                 LocData(8,  "Region 1 - Central"),
    ...
    "Smile Token Puzzle 1":                 LocData(19, "Region 2 - Sector 2"),
    ...
    "George Reward":                        LocData(32, "Region 2 - Left"),
    "Shadow Chase Pickup":                  LocData(33, "Region 2 - Shadow Chase"),
    "Master Puzzle 1":                      LocData(34, "Region 2 - Sector 2"),

    # Region 3
    "Green Stone Trial":                    LocData(35, "Region 3"),
    "Blue Stone Trial":                     LocData(36, "Region 3"),
    "Red Stone Trial":                      LocData(37, "Region 3"),
    "Silver Shard Puzzle 10":               LocData(38, "Region 3"),
    "Silver Shard Puzzle 11":               LocData(39, "Region 3"),
    "Silver Shard Puzzle 12":               LocData(40, "Region 3"),
    "Silver Shard Puzzle 13":               LocData(41, "Region 3"),
    "Silver Shard Puzzle 14":               LocData(42, "Region 3"),
    "Smile Token Puzzle 2":                 LocData(43, "Region 3"),
    "Smile Token Puzzle 7":                 LocData(44, "Region 3"),
    "Master Puzzle 3":                      LocData(45, "Region 3"),

    # Region 4
    "Spearman Reward":                      LocData(46, "Region 4 - Upper"),
    "Multiparry Gold Shard Puzzle":         LocData(47, "Region 4 - Central"),
    "Platforming Gold Shard Room":          LocData(48, "Region 4 - Central"),
    "Flower Puzzle Reward":                 LocData(49, "Region 4 - Central"),
    "Smile Token Puzzle 4":                 LocData(50, "Region 4 - Central"),
    "Smile Token Puzzle 5":                 LocData(51, "Region 4 - Entrance"),
    "On top of the Rosetta Stone Pickup":   LocData(52, "Region 4 - Central"),
    "Long Parry Platforming Room Pickup":   LocData(53, "Region 4 - Lower"),

    # Dark Region
    "Secret Room Pickup":                   LocData(54, "Dark Region"),
    "Large Room Pickup in the Corner":      LocData(55, "Dark Region"),

    # Smile Shop
    "Smile Shop Item 1":                    LocData(56, "Smile Shop"),
    "Smile Shop Item 2":                    LocData(57, "Smile Shop"),
    "Smile Shop Item 3":                    LocData(58, "Smile Shop"),
    "Smile Shop Item 4":                    LocData(59, "Smile Shop"),
    "Dash Puzzle Reward":                   LocData(60, "Smile Shop"),

    # The Between
    "Between Reward":                       LocData(61, "The Between"),

    # Collapse
    "Escape Normal Sequence Pickup":        LocData(62, "Collapse"),
